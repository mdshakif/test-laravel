            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post" action="{{url('/adminlogin')}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="a_email" placeholder="email">
                </div>
                <div class="form-group">
                  <label>Password </label>
                  <input type="password" class="form-control p_input" name="a_password" placeholder="password">
                </div>
